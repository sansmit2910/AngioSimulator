...
title_text = title_font.render("Angiogram Simulator", True, BLACK)
...
instructions_texts = [instructions_font.render(line, True, BLACK) for line in instructions_lines]

# calculate the total height of the instructions text
instructions_height = sum(text.get_height() for text in instructions_texts)

# set the position for the instructions text
instructions_x = (screen_size[0] - max(text.get_width() for text in instructions_texts)) // 2
instructions_y = title_rect.bottom + 50
...
while running:
    ...
    for i, text in enumerate(instructions_texts):
        text_x = instructions_x
        text_y = instructions_y + i * (text.get_height() + 10)
...
script_a_path = r"/home/whale/Downloads/NATIVE_01.py"
script_b_path = r"/home/whale/Downloads/ROADMAP_02.py"
script_c_path = r"/home/whale/Downloads/DSA_02.py"
